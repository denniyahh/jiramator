...
from jiramator.planner import _resolve_sprint_ids, _SPRINT_FIELD
...
class TestResolveSprintIds:
    ...
    def test_injects_sprint_field_and_strips_metadata(self):
        ...
        _resolve_sprint_ids(client, tc, "28", payloads, _make_console())

        assert payloads[0]["fields"][_SPRINT_FIELD] == 100
        assert payloads[1]["fields"][_SPRINT_FIELD] == 101
        assert _SPRINT_FIELD not in payloads[2]["fields"]
    ...
    def test_unresolved_sprint_leaves_no_field(self):
        ...
        assert _SPRINT_FIELD not in payloads[0]["fields"]
        assert "_sprint_num" not in payloads[0]
    ...
    def test_skips_when_no_board_id(self):
        ...
        _resolve_sprint_ids(MagicMock(), tc, "28", payloads, _make_console())
    ...
    def test_long_sprint_suffixes(self):
        ...
        assert payloads[0]["fields"][_SPRINT_FIELD] == 200
        assert payloads[1]["fields"][_SPRINT_FIELD] == 201
